...
def morse_encode(sentence):
    """
    Функция кодирования предложения в Азбуку-Морзе
    :param sentence: искомое предложение
    :return: возвращает закодированное предложение str
    """
...
def get_sentence():
    """
    Функция получения предложения или слова из списка
    :return: возвращает слово или целое предложение из списка str
    """
...
def print_statistics(statistics):
    """
    Функция вывода статистики игры
    :param statistics: данные статистики
    :return: возвращает строку в которой показано количество задач, верных и неверных ответов str
    """
